...
def generate_train_val_test(args):
    ...
    # num_train = round(num_samples * 0.7) # PEMS-BAY METR-LA
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, choices=['METRLA', 'PEMSBAY', 'PEMS04', 'PEMS07622', 'PEMS08', 'PEMS03'], default='PEMS04', help='which dataset to run')
